...
import { thumbnailIndexSchema, thumbnailKindSchema } from "./thumbnail.js";
...
export type ThumbnailMessage = Extract<QueueMessage, { kind: "thumbnail" }>;
